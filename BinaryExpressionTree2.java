public class BinaryExpressionTree2 {
    ...
    public static String postfixFromInfix(String infix) throws IllegalArgumentException {
        ...
        for (int i = 0; i < infix.length(); i++) {
            ...
            else if(DIGITS.indexOf(infix.charAt(i)) != -1 || infix.charAt(i)=='.')
            {
                postfix = postfix + infix.charAt(i);
                if(DIGITS.indexOf(infix.charAt(i+1)) == -1 && infix.charAt(i+1) !='.')
            ...
            throws IllegalArgumentException
    {
        ...
        {
            if(DIGITS.indexOf(postfix.charAt(i)) != -1 || postfix.charAt(i) == '.') {
                String temp = "";
                while (DIGITS.indexOf(postfix.charAt(i)) != -1 || postfix.charAt(i) == '.') {
     ...
     */
    public static float valueOfExpressionTree(LinkedBinaryTree<String> tree)//postfix로 변경 후 value 계산
    {
        /**
        ...
        else
        {
            ...
            {
                if(DIGITS.indexOf(toPostfix.charAt(i)) != -1 || toPostfix.charAt(i) == '.')
                {
                    float n = 0;
                    String temp = "";
                    while (DIGITS.indexOf(toPostfix.charAt(i)) != -1 || toPostfix.charAt(i) == '.') {
